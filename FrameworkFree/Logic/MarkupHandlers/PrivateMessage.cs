...
namespace Own.MarkupHandlers
{
    ...
    {
        internal static string SetNewCompanionPageMarkup(in int id, in string companionNick)
        {
        ...
        internal static string GetPrivateMessageArrows
        ...
        internal static string SetNavigation
            (in int pageNumber, in int pagesCount, in int authorId, in string companionNick)
        {
            return string.Concat(GetPrivateMessageArrows(pageNumber, pagesCount, authorId),
                    "<div id='a'><a onClick='f();return false'>Ответить ",
                    companionNick,
                    "</a></div>");
        }
        internal static PrivateMessages ProcessCompanionReaderMarkup(in string companionNick, in int companionId,
