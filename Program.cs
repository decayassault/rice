...
builder.Services.AddSingleton<IAccountUnstable, AccountUnstable>();
builder.Services.AddSingleton<IAuthenticationUnstable, AuthenticationUnstable>();
builder.Services.AddSingleton<IUnstableSequential, UnstableSequential>();
builder.Services.AddSingleton<IStableSequential, StableSequential>();
builder.Services.AddSingleton<ISequential, Sequential>();
...
builder.Services.AddSingleton<IUnstableInRace, UnstableInRace>();
builder.Services.AddSingleton<IStableInRace, StableInRace>();
builder.Services.AddSingleton<IInRace, InRace>();
